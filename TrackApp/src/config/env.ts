...
export const ENV = {
  SUPABASE_URL: readEnv('EXPO_PUBLIC_SUPABASE_URL', readEnv('SUPABASE_URL', 'https://YOUR_PROJECT.supabase.co')),
  SUPABASE_ANON_KEY: readEnv('EXPO_PUBLIC_SUPABASE_ANON_KEY', readEnv('SUPABASE_ANON_KEY', 'YOUR_ANON_KEY')),
