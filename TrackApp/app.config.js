...
module.exports = {
  expo: {
    ...
    extra: {
      ...(baseConfig.extra ?? {}),
      // TODO: Vervang de Google Maps keys via .env of Expo public env vars.
      supabaseUrl: process.env.NEXT_PUBLIC_SUPABASE_URL ?? process.env.EXPO_PUBLIC_SUPABASE_URL ?? process.env.SUPABASE_URL ?? 'https://YOUR_PROJECT.supabase.co',
      supabaseAnonKey: process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY ?? process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY ?? process.env.SUPABASE_ANON_KEY ?? 'YOUR_ANON_KEY',
